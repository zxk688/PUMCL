...
dataset_dict = {
    'UCMD': {
        "source": {
            "train_path": 'dataset_csv/UCMD_source/train.csv',
            "val_path": 'dataset_csv/UCMD_source/val.csv',
            "test_path": 'dataset_csv/UCMD_source/test.csv',
            'database_path': 'dataset_csv/UCMD_source/database.csv'
        }
    },
    'NWPU': {
        "target": {
            "train_path": 'dataset_csv/NWPU_target/train.csv',
            "val_path": 'dataset_csv/NWPU_target/val.csv',
            "test_path": 'dataset_csv/NWPU_target/test.csv',
            'database_path': 'dataset_csv/NWPU_target/database.csv',
